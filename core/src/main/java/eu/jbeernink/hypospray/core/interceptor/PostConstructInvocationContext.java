...
public final class PostConstructInvocationContext extends InvocationContextImpl {

	private final InvocationChain invocationChain;

	public PostConstructInvocationContext(Map<String, Object> contextData, InvocationChain invocationChain) {
	...
	public Object proceed() throws Exception {
		return switch (invocationChain) {
			case InterceptorInvocationChain(InterceptorInstance<?> interceptor, InvocationChain next) ->
					interceptor.postConstruct(new PostConstructInvocationContext(getContextData(), next));
